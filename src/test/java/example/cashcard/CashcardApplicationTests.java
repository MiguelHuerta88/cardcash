...
class CashcardApplicationTests {
	...
	@Test
	@DirtiesContext // this annotation should be avoided if possible
	...
	@Test
	public void shouldReturnSortedPageOfCashCards() {
	...
	@Test
	public void shouldReturnASortedPageOdCashCardsWithNoParametersAndUseDefaultValues() {
		ResponseEntity<String> response = restTemplate.getForEntity("/cashcards", String.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
